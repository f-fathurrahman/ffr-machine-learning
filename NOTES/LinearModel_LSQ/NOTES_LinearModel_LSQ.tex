...
\documentclass[b5paper,12pt]{article} % screen setting
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.75]{codes_py/IMG_fit_linear_olympic100_simple.pdf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.75]{codes_py/IMG_fit_poly3_olympic100.pdf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.75]{codes_jl/IMG_linreg_polynom_8.pdf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.75]{codes_py/IMG_reg_fit_poly5_synth.pdf}
\end{center}
\end{figure}
