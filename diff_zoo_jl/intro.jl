...
# \frac{\mathrm{d}}{\mathrm{d}x} (-u) &= - \frac{\mathrm{d}u}{\mathrm{d}x} \\
# \frac{\mathrm{d}}{\mathrm{d}x} (u + v) &= \frac{\mathrm{d}u}{\mathrm{d}x} + \frac{\mathrm{d}v}{\mathrm{d}x} \\
# \frac{\mathrm{d}}{\mathrm{d}x} (u * v) &= v \frac{\mathrm{d}u}{\mathrm{d}x} + u \frac{\mathrm{d}v}{\mathrm{d}x} \\
# \frac{\mathrm{d}}{\mathrm{d}x} (u / v) &= (v \frac{\mathrm{d}u}{\mathrm{d}x} - u \frac{\mathrm{d}v}{\mathrm{d}x}) / v^2 \\
# \frac{\mathrm{d}}{\mathrm{d}x} u^n &= n u^{n-1} \\
# \end{align}
# $$

# Seeing $\frac{\mathrm{d}}{\mathrm{d}x}(u)$ as a function, these rules look a lot like a
