...
# %% [markdown]
# Dari plot, terlihat bahwa time series ini tidak stasioner. Kita akan coba uji juga dengan uji ADF:
...
# %% [markdown]
# Nilai $p$ besar dan statistik ADF cukup dekat dengan 0, sehingga menurut uji ADF time series ini tidak stasioner.
...
# %% [markdown]
# Time series (hasil diferensi) terlihat stasioner. Lakukan uji ADF:
...
# %% [markdown]
# Menurut uji ADF time series ini stasioner.
...
# %% [markdown]
# ACF untuk time series hasil diferensi menunjukkan korelasi yang masih tinggi, bahkan untuk nilai lag yang cukup besar.
