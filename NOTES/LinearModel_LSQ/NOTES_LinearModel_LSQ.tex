...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.75]{codes_jl/IMG_linreg_simple.pdf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.75]{codes_jl/IMG_linreg_polynom_3.pdf}
\end{center}
...
\begin{figure}[H]
\begin{center}
\includegraphics[scale=0.75]{codes_jl/IMG_linreg_regularized_01.pdf}
\end{center}
\end{figure}
